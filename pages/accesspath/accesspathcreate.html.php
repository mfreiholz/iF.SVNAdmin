  ...
  <div>
    <form method="POST" action="accesspathcreate.php">
      ...
      <div class="form-field">
        ...
        <input type="text" name="path" id="path" class="lineedit"
               value="<?php PrintStringValue("DefaultAccessPath"); ?>">
        <p>
      ...
      <div class="form-field">
        ...
        <input type="text" name="accesspathdesc" id="accesspathdesc" class="lineedit"> <!-- input access path description information -->
        <p>
