...
class SvnAuthFile {
  ...
  public function createGroup($groupname) {
    ...
    if (!preg_match($pattern, $groupname)) {
      throw new Exception('Invalid group name "' . $groupname . '". Allowed signs are: A-Z, a-z, Underscore, Dash, (no spaces!) ');
    }
   ...
   *
   * @param string $username
   * @param bool $resolveGroups
   *          (default=true) Indicates whether groups and *-user should be resolved, too.
   * @param string $filterRepository
   *          (default=null) Restricts the returning array to the given repository.
   *
   ...
   * @param string $groupname
   * @param bool $resolveGroups
   *          (default=true) Indicates whether groups should be resolved, too.
   * @param string $filterRepository
   *          (default=null) Restricts the returning array to the given repository.
   *
   * @return array See method description for details.
