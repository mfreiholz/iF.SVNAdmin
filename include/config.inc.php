...
// Error level.
// log will write to the log file. such as /var/log/httpd/error_log
// can use error_log($message) or if_log_debug($message) or if_log_array($array, $message) to write log.
...
// data folder need 777 permission
...
define("ACL_ACTION_DOWNLOAD_ACCESS_PATH", "accesspath");      // ACL_MOD_REPO
 ...
 */
$appEngine = \svnadmin\core\Engine::getInstance(); // app engine. core object.
...
/**
 * User view provider.
 * use three methods view provider, passwd,ldap or digest.
 * different provider will can different php file. and different user page.
 */
 ...
 * Group view provider.
 */
// basic method use svnauthfile (SVNAuthFile=/home/svn/authz ) to control the user group
