...
class RepositoryViewProvider implements \svnadmin\core\interfaces\IRepositoryViewProvider
{
  ...
  /**
   * get all the repositories list of the svn root path.
