  ...
  \svnadmin\core\interfaces\IPathsEditProvider
{
  ...
  public function save()
  {
    ...
    // see the IF_SVNAuthFileC.class.php file
   ...
   * @param $objGroup
   * @param null $group_reason
   * @return bool
   */
  public function addGroup($objGroup, $group_reason = null)
  {
    return $this->m_authfile->createGroup($objGroup->name, $group_reason);
  }
  ...
  /**
   * get all the repositories and repositories path
   * (non-PHPdoc)
  ...
  public function getPaths()
  {
    $list = array();
    // get all the repositories and repositories path
    // @see include/ifcorelib/IF_SVNAuthFileC.class.php
    ...
    for ($i = 0; $i < count($paths); $i++) {
      ...
      $o->path = $paths[$i];
      // get the section description imformation
      // @see include/ifcorelib/IF_SVNAuthFileC.class.php
